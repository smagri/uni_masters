...
*/
	  ...
	  // NOTE: for  some reason we  cant define waypoints  in this
	  // part of  the code, we  get abort at  runtime???  Probably
	  // cause you cant'd define containers  inline as you do ints
	  // or other types that aren't containers.
	  //
	  // DUMMY path WAYPOINTS:
	  // std::vector<double> xWaypoint = {0.0, 50.0, 100.0, 150.0, 0.0};
	  // std::vector<double> yWaypoint = {0.0, 50.0, 100.0, 150.0, 0.0};
