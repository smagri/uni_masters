...
if("FALSE" STREQUAL "TRUE")
  ...
  set(a3_help_DEVEL_PREFIX /lu1/smagri/uni/subj/proj30cp/catkin_ws/src/a3_help/build/devel)
  set(a3_help_INSTALL_PREFIX "")
  set(a3_help_PREFIX ${a3_help_DEVEL_PREFIX})
else()
  set(a3_help_SOURCE_PREFIX "")
  set(a3_help_DEVEL_PREFIX "")
  set(a3_help_INSTALL_PREFIX /usr/local)
...
if(NOT "/lu1/smagri/uni/subj/proj30cp/catkin_ws/devel/include;include " STREQUAL " ")
  set(a3_help_INCLUDE_DIRS "")
  set(_include_dirs "/lu1/smagri/uni/subj/proj30cp/catkin_ws/devel/include;include")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'a3_help' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/usr/local/${idir}'.  Ask the maintainer 'student <student@todo.todo>' to fix it.")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /usr/local/lib;/lu1/smagri/uni/subj/proj30cp/catkin_ws/devel/lib;/opt/ros/indigo/lib)
...
set(a3_help_EXPORTED_TARGETS "a3_help_generate_messages_cpp;a3_help_generate_messages_lisp;a3_help_generate_messages_py;a3_help_generate_messages_cpp;a3_help_generate_messages_lisp;a3_help_generate_messages_py")
