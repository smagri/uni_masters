...
namespace a3_help{
  ...
  public:
    ...
    struct Response{
      ...
      // Call to service, "request_goal"
      // true=> request succeeded
      // false=> request failed
      bool ack;

      // PoseArray.msg = an array of poses for the obsticale free path
      // to the next FT node.
      //
      // This is filled by pathCallback() ???
      std::vector<std::deque<geometry_msgs::Pose> > pathResponce;
    }
