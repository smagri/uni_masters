...
int main(int argc, char *argv[]){
  ...
  //vector<Ranger *> laserRangers = {&l1}; // add too rangers_
  ...
  // I think there is something really worng here, no time to fix???
  //
  //l1.setRangers(rangers);
  //l1.setRangers(laserRangers);
  //vector<Ranger *> laserRangers;
  // wrks: l1.Laser::RangerFusion::setRangers(rangers);
  // Laser l2("UTM-XXL", 115200, "/dev/ttyACM1");
  // laserRangers = {&l1, &l2};

  // vector<Ranger *> radarRangers;
  // vector<Ranger *> sonarRangers;
  //r1.setRangers(radarRangers); //adds to rangers_
  //s1.setRangers(sonarRangers); //adds to rangers_
