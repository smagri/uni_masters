...
int Ranger::readRanger(vector<double> &rawData_,
  ...
  // Read raw data from the sensor.q
  // Random numbers are used to simulate data from the sensor.q
  ...
  for (int i=0; i<numSamples; i++){
    ...
    fprintf(stderr, "dbg: curRandomNum Unclipped=%f\n", curRandomNum);
    ...
    fprintf(stderr, "dbg: curRandomNum clipped=%f\n", curRandomNum);
