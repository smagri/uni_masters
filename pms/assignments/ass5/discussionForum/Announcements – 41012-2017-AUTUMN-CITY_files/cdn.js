...
var localeArray = ['en_GB', 'en_US', 'es_ES', 'fr_FR', 'it_IT', 'de_DE', 'nl_NL', 'ru_RU', 'sv_SE', 'zh_CN', 'ja_JP', 'zh_TW', 'ar_SA', 'cy_GB', 'da_DK', 'en_US_k12', 'en_US_pro', 'pt_BR', 'ko_KR', 'tr_TR', 'cs_CZ', 'pl_PL', 'th_TH', 'ms_MY'];
var ltrArray = ['Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'N', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y'];
