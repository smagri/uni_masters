...
void DataFusion::processBuffers(){
  ...
  // Could this  routine be turned  into a more generic  function like
  // fillBuffer(), wth the use of rangerNum as an argument variable???
  ...
  while(true){
    ...
    fprintf(stderr, "dbg: processBuffers: Before unLock of Lock%d.\n",
	    rangerNum);
