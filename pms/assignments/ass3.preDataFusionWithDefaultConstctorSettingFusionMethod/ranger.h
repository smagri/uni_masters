...
class Ranger{
 ...
 public:
  ...
  int readRanger(vector<double> &rawData_, vector<double> &rawDataTimestamp_,
		 int samplingRate, int numSamples_);
  //
  vector<double> getRawData(void);
 ...
 protected:
  ...
  //
  /// timestamp for raw sampled data for each sensor/ranger
