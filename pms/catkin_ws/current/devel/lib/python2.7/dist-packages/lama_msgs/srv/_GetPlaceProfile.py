...
"""autogenerated by genpy from lama_msgs/GetPlaceProfileRequest.msg. Do not edit."""
import sys
...
class GetPlaceProfileRequest(genpy.Message):
  _md5sum = "c5e4a7d59c68f74eabcec876a00216aa"
  _type = "lama_msgs/GetPlaceProfileRequest"
...
"""
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(GetPlaceProfileRequest, self).__init__(*args, **kwds)
...
# This Python file uses the following encoding: utf-8
"""autogenerated by genpy from lama_msgs/GetPlaceProfileResponse.msg. Do not edit."""
import sys
python3 = True if sys.hexversion > 0x03000000 else False
import genpy
import struct
...
class GetPlaceProfileResponse(genpy.Message):
  _md5sum = "f528bce67fe2dc9e2ab90ef5f1e58071"
  _type = "lama_msgs/GetPlaceProfileResponse"
  _has_header = False #flag to mark the presence of a Header object
...
"""
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(GetPlaceProfileResponse, self).__init__(*args, **kwds)
      #message fields cannot be None, assign default values for those that are
...
class GetPlaceProfile(object):
  _type          = 'lama_msgs/GetPlaceProfile'
  _md5sum = '1618b57072692f88573b9b9dff6edef8'
  _request_class  = GetPlaceProfileRequest
  _response_class = GetPlaceProfileResponse
