...
(cl:defmethod cl:initialize-instance :after ((m <NodeExampleData>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'NodeExampleData)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name node_example-msg:<NodeExampleData> is deprecated: use node_example-msg:NodeExampleData instead.")))
