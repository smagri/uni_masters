...
if("TRUE" STREQUAL "TRUE")
  set(beginner_tutorials_SOURCE_PREFIX /lu1/smagri/uni/subj/proj30cp/catkin_ws/src/beginner_tutorials)
  set(beginner_tutorials_DEVEL_PREFIX /lu1/smagri/uni/subj/proj30cp/catkin_ws/devel)
  ...
  set(beginner_tutorials_INSTALL_PREFIX /lu1/smagri/uni/subj/proj30cp/catkin_ws/install)
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'beginner_tutorials' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'Simone Magri <smagri@exemail.com.au>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'beginner_tutorials' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/lu1/smagri/uni/subj/proj30cp/catkin_ws/src/beginner_tutorials/${idir}'.  Ask the maintainer 'Simone Magri <smagri@exemail.com.au>' to fix it.")
    endif()
