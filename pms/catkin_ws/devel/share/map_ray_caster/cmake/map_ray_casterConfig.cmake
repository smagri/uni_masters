...
if("TRUE" STREQUAL "TRUE")
  set(map_ray_caster_SOURCE_PREFIX /lu1/smagri/uni/subj/proj30cp/catkin_ws/src/map_ray_caster)
  set(map_ray_caster_DEVEL_PREFIX /lu1/smagri/uni/subj/proj30cp/catkin_ws/devel)
  ...
  set(map_ray_caster_INSTALL_PREFIX /lu1/smagri/uni/subj/proj30cp/catkin_ws/install)
...
if(NOT "/lu1/smagri/uni/subj/proj30cp/catkin_ws/src/map_ray_caster/include " STREQUAL " ")
  set(map_ray_caster_INCLUDE_DIRS "")
  set(_include_dirs "/lu1/smagri/uni/subj/proj30cp/catkin_ws/src/map_ray_caster/include")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'map_ray_caster' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/lu1/smagri/uni/subj/proj30cp/catkin_ws/src/map_ray_caster/${idir}'.  Ask the maintainer 'Gaël Ecorchard <gael.ecorchard@ciirc.cvut.cz>' to fix it.")
    endif()
...
foreach(depend ${depends})
  ...
  if(${count} EQUAL 1)
    ...
    if(NOT ${map_ray_caster_dep}_FOUND)
      find_package(${map_ray_caster_dep} REQUIRED)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${map_ray_caster_dep} REQUIRED ${depend_list})
  endif()
