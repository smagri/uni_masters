...
// !wrks void (*funcs[])() = { fa, fb, fc, fd, fe, nullptr };
//
// NULL is a pointer!!!
//
// function name fa is address of fa, thus pointers to the functions,
// kind of like arrays.
//
// funcs is an array of function pointers
void (*funcs[])() = { fa, fb, fc, fd, fe, NULL };
