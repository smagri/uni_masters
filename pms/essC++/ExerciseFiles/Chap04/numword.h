...
// nine hundred ninty-nine quadrillion nine hundred ninty-nine
// trillion nine hundred ninty-nine billion nine hundred ninty-nine
// million nine hundred ninty-nine thousand nine hundred ninty-nine
#define _BW_MAXNUM 999999999999999999

// use namespce bw here as we don't want collisions with these names
// and that of other classes
namespace bw {
