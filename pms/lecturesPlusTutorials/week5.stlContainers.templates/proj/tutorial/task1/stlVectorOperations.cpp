...
int populateVec(vector<double> &randomNumVec){
...
void printValues(vector<double> &randomNumVec){

  cout << "in printValues:" << endl;

  // long hand for the first time.
  vector<double>::iterator it;
  vector<double>::iterator itbegin = randomNumVec.begin();
  vector<double>::iterator itend = randomNumVec.end();
...
int bubbleSortVec(vector<double> &randomNumVec){
