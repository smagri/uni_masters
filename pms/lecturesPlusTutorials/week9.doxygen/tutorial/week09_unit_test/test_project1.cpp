...
// SquareRootRootTest does PositiveNos
TEST(SquareRootTest, PositiveNos) {
  ...
  // EXPECT_EQ(expected, actual), use floats as they may not be
  // expected==actual due to rounding errors.
  EXPECT_FLOAT_EQ (50.3320, squareroot (2533.310224));
}
